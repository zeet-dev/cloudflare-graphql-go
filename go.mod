module github.com/zeet-dev/cloudflare-graphql-go

go 1.22.3

require (
	github.com/Khan/genqlient v0.0.0-00010101000000-000000000000
...
replace github.com/Khan/genqlient => github.com/zeet-dev/genqlient v0.0.0-20240313182549-778d6a9998a6
